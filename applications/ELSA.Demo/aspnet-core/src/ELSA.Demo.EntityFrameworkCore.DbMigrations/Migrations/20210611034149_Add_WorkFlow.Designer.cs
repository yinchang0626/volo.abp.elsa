...
namespace ELSA.Demo.Migrations
{
    ...
    [Migration("20210611034149_Add_WorkFlow")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Volo.Abp.WorkFlowManagement.ActivityDefinition", b =>
                {
                    ...
                    b.ToTable("WorkFlowManagementActivityDefinitions");
                });

            modelBuilder.Entity("Volo.Abp.WorkFlowManagement.ActivityInstance", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("WorkFlowManagementActivityInstances");
                });

            modelBuilder.Entity("Volo.Abp.WorkFlowManagement.BlockingActivity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("WorkFlowManagementBlockingActivitys");
                });

            modelBuilder.Entity("Volo.Abp.WorkFlowManagement.ConnectionDefinition", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("WorkFlowManagementConnectionDefinitions");
                });

            modelBuilder.Entity("Volo.Abp.WorkFlowManagement.WorkflowDefinitionVersion", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("WorkFlowManagementWorkflowDefinitionVersions");
                });

            modelBuilder.Entity("Volo.Abp.WorkFlowManagement.WorkflowInstance", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("WorkFlowManagementWorkflowInstances");
                });
            ...
            modelBuilder.Entity("Volo.Abp.WorkFlowManagement.ActivityDefinition", b =>
                {
                    b.HasOne("Volo.Abp.WorkFlowManagement.WorkflowDefinitionVersion", "WorkflowDefinitionVersion")
                        .WithMany("Activities")
            ...
            modelBuilder.Entity("Volo.Abp.WorkFlowManagement.ActivityInstance", b =>
                {
                    b.HasOne("Volo.Abp.WorkFlowManagement.WorkflowInstance", "WorkflowInstance")
                        .WithMany("Activities")
